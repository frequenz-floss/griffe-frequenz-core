# Contributing to Griffe Extensions for frequenz-core
...
5. A GitHub action will test the tag and if all goes well it will create
   a [GitHub
   Release](https://github.com/frequenz-floss/griffe-frequenz-core/releases),
   and upload a new package to
   [PyPI](https://pypi.org/project/griffe-frequenz-core/)
   automatically.
